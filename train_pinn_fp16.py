...
def train_one_epoch(epoch, phase_name, start_time):
    ...
    optimizer.zero_grad()
    fp16_context = torch.autocast(device_type=device.type, dtype=FP16_DTYPE, enabled=USE_FP16)
    fp16_context.__enter__()
    ...
    fp16_context.__exit__(None, None, None)
